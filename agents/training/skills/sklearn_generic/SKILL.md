...
### Step 1 — Get parameter options

Call `get_model_params` with the chosen estimator name to retrieve the available hyperparameters and their defaults.

<!-- TODO: implement get_model_params script -->

### Step 2 — Train the model

Call the training script at `agents/training/skills/sklearn_generic/train.py` with the chosen estimator and parameters.
