...
import { Plus, MessageSquare, Loader2, CheckCircle2, AlertCircle, Trash2, FlaskConical, Database, Box, Moon, Shield } from "lucide-react"
...
export type AppTab = "experiment_lab" | "broker_demo" | "datasets" | "models"
...
const navItems: { id: AppTab; label: string; icon: React.ReactNode }[] = [
  ...
  { id: "broker_demo", label: "Broker demo", icon: <Shield className="h-4 w-4 shrink-0 opacity-90" /> },
